...
class DbTest extends TestCase
{
    ...
    function testCreateSqlite() {
        $path = tempnam(sys_get_temp_dir(), "db-test-");
        Assert::truthy($path);
    ...
    function testGeneratedValue() {
        ...
        $y = Db::load('test', 2);
        // TODO: Need better way to get date.
        Assert::equal($date1->getTimestamp(), strtotime("{$y->t} +0000"));
        ...
        $y = Db::load('test', 3);
        Assert::equal($date2->getTimestamp(), strtotime("{$y->t} +0000"));
    }
